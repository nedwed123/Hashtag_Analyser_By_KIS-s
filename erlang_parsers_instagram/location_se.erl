...
pmap_id()->
S = self(),
  L=["https://api.instagram.com/v1/locations/search?lat=57.706922&lng=11.967891&distance=5000&access_token=ACCESS-TOKEN",
  "https://api.instagram.com/v1/locations/search?lat=57.696629&lng=11.986935&distance=5000&access_token=ACCESS-TOKEN",
  "https://api.instagram.com/v1/locations/search?lat=59.330126&lng=18.068741&distance=5000&access_token=ACCESS-TOKEN",
  "https://api.instagram.com/v1/locations/search?lat=59.330769&lng=18.057937&distance=5000&access_token=ACCESS-TOKEN"],
   Pids = [spawn(fun () ->
