...
pmap_id()->
S = self(),
  L=["https://api.instagram.com/v1/locations/search?lat=61.500604&lng=23.766560&distance=5000&access_token=ACCESS-TOKEN",
  "https://api.instagram.com/v1/locations/search?lat=60.240324&lng=24.880732&distance=5000&access_token=ACCESS-TOKEN"],
   Pids = [spawn(fun () ->
