...
pmap_id()->
S = self(),
  L=["https://api.instagram.com/v1/locations/search?lat=55.758778&lng=12.501918&distance=5000&access_token=511546223.4dc6143.f86f1a1df18d45d3865cd4b75387beb3"],
   Pids = [spawn(fun () ->
